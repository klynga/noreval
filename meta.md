...
| `norbelebele_nob` | language_understanding | nob | acc | 0.25 |
| `norec_document_nob` | language_understanding | nob | f1 | 0.4850709806 |
| `norec_sentence_nob` | language_understanding | nob | f1 | 0.4815172167 |
| `noropenbookqa_nob` | language_understanding | nob | acc | 0.25 |
| `noropenbookqa_nno` | language_understanding | nno | acc | 0.25 |
| `norquad_nob` | language_understanding | nob | f1 | 0.0 |
| `norcommonsenseqa_nob` | world_knowledge_and_reasoning | nob | acc | 0.2 |
| `norcommonsenseqa_nno` | world_knowledge_and_reasoning | nno | acc | 0.2 |
| `noropenbookqa_no_fact_nob` | world_knowledge_and_reasoning | nob | acc | 0.25 |
| `noropenbookqa_no_fact_nno` | world_knowledge_and_reasoning | nno | acc | 0.25 |
| `nortruthfulqa_gen_nob` | world_knowledge_and_reasoning | nob | rougeL_max | 0.0 |
| `nortruthfulqa_gen_nno` | world_knowledge_and_reasoning | nno | rougeL_max | 0.0 |
| `nortruthfulqa_mc_nob` | world_knowledge_and_reasoning | nob | acc | 0.23170337745132827 |
| `nortruthfulqa_mc_nno` | world_knowledge_and_reasoning | nno | acc | 0.23311814890762259 |
| `nrk_quiz_qa_nob` | world_knowledge_and_reasoning | nob | acc | 0.2836296296296296 |
| `nrk_quiz_qa_nno` | world_knowledge_and_reasoning | nno | acc | 0.27884711779448623 |
| `norrewrite_instruct_nob` | generation_and_summarization | nob | bleu | 0.0 |

...
```bash
python3 ask_gec_nob/errant.py --fpath results/ask_gec_nob/0-shot/AI-Sweden-Models__Llama-3-8B/samples_ask_gec_nob_p0_2025-01-28T01-08-13.454441.jsonl --out_fdir results/ask_gec_nob/0-shot/AI-Sweden-Models__Llama-3-8B/
```

...
|:---|:---|:---|:---|:---|:---|
|[NoReC Sentence](https://huggingface.co/datasets/ltg/norec_sentence) |`norec_sentence_nob`  | — | — |Text classification| Language understanding |
|[NoReC Document](https://huggingface.co/datasets/ltg/norec_document) |`norec_document_nob`  | — | — |Text classification| Language understanding |
|[SLIDE](https://huggingface.co/datasets/ltg/slide) |`slide_nob_nno_swe_dan`  | `slide_nob_nno_swe_dan` | — |Text classification| Linguistic knowledge |
|[NCB](https://huggingface.co/datasets/hcfa/ncb) |`ncb_nob`| — | — |Text classification| Linguistic knowledge   |
|[NoCoLA](https://huggingface.co/datasets/ltg/nocola) |`nocola_nob`| — | — |Text classification| Linguistic knowledge   |
|[MultiBLiMP](https://huggingface.co/datasets/jumelet/multiblimp) | — | — |`multiblimp_sme`|Text classification| Linguistic knowledge |
...
|[NorBelebele](https://huggingface.co/datasets/ltg/norbelebele) |`norbelebele_nob`| —| — |Text classification| Language understanding |
...
|[NorQuAD](https://huggingface.co/datasets/ltg/norquad) |`norquad_nob`| —  | — |Text generation| Language understanding |
|[ASK-GEC](https://huggingface.co/datasets/ltg/ask-gec) |`ask_gec_nob`| — | — |Text generation| Linguistic knowledge |
...
|[NorSumm Translation (Bokmål ↔ Nynorsk)](https://huggingface.co/datasets/ltg/norsumm-nob-nno-translation) | `norsumm_translation_nob_nno`| `norsumm_translation_nno_nob`  | — |Text generation|Generation and summarization |
...
|[NorRewrite-Instruct](https://huggingface.co/datasets/ltg/norrewrite-instruct) |`norrewrite_instruct_nob`  | — | — |Text generation|Generation and summarization|
|[NorSummarize-Instruct](https://huggingface.co/datasets/ltg/norsummarize-instruct) |`norsummarize_instruct_nob` | — | — |Text generation|Generation and summarization|

<details>
<summary><b>Table description</b></summary>

* **Name**: a dataset name with a HuggingFace link.
* **Bokmål**: the LM Evaluation Harness task name for the Norwegian Bokmål dataset. `slide_nob_nno_swe_dan`, which covers Bokmål, Nynorsk, Danish, and Swedish, is also listed here.
...
lm_eval \
  ...
  --tasks norquad_nob \
  --output results/norquad_nob/0-shot/ \
  --show_config \
  --write_out \
  --batch_size auto \
  --num_fewshot 0
...
* The task names in the table above run all prompt variants of a dataset at once; append a prompt index to run a single variant (e.g. `norquad_nob_p2`).
...
* `ask_gec_nob` does not compute a metric inside the harness: run it with `--log_samples` and score the generated corrections externally with [ERRANT](https://github.com/chrisjbryant/errant) (F0.5).
